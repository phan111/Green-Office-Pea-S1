<?php
  ...
  $keyw = 'SELECT * FROM detail WHERE detail_id = '.$_GET['id'].'';
  $keyw = $con->query($keyw);
...
<div class="container mt-3">
  ...
  ?>
  <form action="https://green-office-peas1.herokuapp.com/detail_update.php" method="post">
    </div>
      <div class="row mt-2">
      <div class="col-2">Subtopic</div>
      <div class="col-10"><input class="form-control" value="<?=$keyw['subtopic']?>" name="subtopic"></div>
    </div>
    <div class="row mt-1">
